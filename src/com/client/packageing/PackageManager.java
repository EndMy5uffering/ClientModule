...
public abstract class PackageManager {
	...
	public PackageManager(Client client, Class<? extends PackageManager> type) {
		if(client == null || type == null)
			throw new NullPointerException("Server and type can not be null!");
		client.getPackageRegistrationManager().getAllPackagesForManager(type).forEach(x -> register(x));
	}
